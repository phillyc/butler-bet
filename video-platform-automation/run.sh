...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo ""
            echo "Single command to run the video pipeline."
            echo ""
            echo "Options:"
            ...
            echo "  --cpu                                Use CPU only (no GPU, slower)"
            echo "  --help                               Show this help"
            echo ""
            echo "Examples:"
            echo "  $0 --niche music --prompt 'chill forest'"
            echo "  $0 --niche storytime --prompt 'roman empire sleep' --channel-id test1"
            echo "  $0 --channel-id test1 --logs"
            echo "  $0 --stop"
            exit 0
            ;;
        *)
