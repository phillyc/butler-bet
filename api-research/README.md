...
- **Monetization:** /usr/bin/bash.01-0.05 per page, or tiered subscription
...
- **Monetization:** 0-200/month per feed, tiered by frequency
...
- **Monetization:** 0-50/month per mailbox
...
- **Monetization:** /usr/bin/bash.05-0.10 per receipt
...
- **Monetization:** /usr/bin/bash.001-0.005 per page
...
- **Monetization:** /usr/bin/bash.01 per MB, or 0/month for 100MB
...
- **Monetization:** 0-200/month for quotas
...
- **Monetization:** /usr/bin/bash.10-1.00 per lookup
